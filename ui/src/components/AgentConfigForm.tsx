...
export function AgentConfigForm(props: AgentConfigFormProps) {
  ...
  const adapterFieldProps = {
    ...
    models,
    refetchModels: hasRemoteModelList ? refetchModels : undefined,
    isFetchingModels: hasRemoteModelList ? isFetchingModels : undefined,
...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local", "codex_local", "gemini_local", "opencode_local", "pi_local", "cursor", "hermes_local", "ollama_local", "lm_studio_local"]);
