        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents} {t("dashboard.activeBudgetIncident")}
                  </p>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {data.agents.running} {t("status.running")}{", "}
                  {data.agents.paused} {t("status.paused")}{", "}
            ...
            <MetricCard
              ...
              description={
                <span>
                  ...
                  {data.tasks.blocked} {t("status.blocked")}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? `${data.budgets.pendingApprovals} ${t("dashboard.budgetOverrides")}`
