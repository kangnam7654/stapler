  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : t("routines.failedToUpdate"),
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : t("routines.runFailed"),
        tone: "error",
      });
    },
  });
        ...
        <DialogContent showCloseButton={false} className="max-w-3xl gap-0 overflow-hidden p-0">
          ...
          <div className="flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:items-end">
              ...
              >
                <Plus className="mr-2 h-4 w-4" />
                {createRoutine.isPending ? t("common.creating") : t("routines.createRoutine")}
              </Button>
      ...
      {error ? (
        <Card>
          <CardContent className="pt-6 text-sm text-destructive">
            {error instanceof Error ? error.message : t("routines.failedToCreate")}
          </CardContent>
        </Card>
      ) : null}
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="text-left text-xs text-muted-foreground border-b border-border">
                  ...
                  <th className="px-3 py-2 font-medium">{t("common.lastRun")}</th>
                  <th className="px-3 py-2 font-medium">{t("common.enabled")}</th>
                      ...
                      <td className="px-3 py-2.5 text-right" onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            >
                              {runningRoutineId === routine.id ? t("common.running") : t("routines.runNow")}
                            </DropdownMenuItem>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem
                              onClick={() =>
